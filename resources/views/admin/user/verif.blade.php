    ...
    <div class="flex">
        ...
        <div class="flex-1 p-6 ml-56">
            <div class="block max-w-2xlg h-full p-6 bg-white rounded-lg shadow-sm dark:bg-gray-800">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Verification User</h5>
                        ...
                        <tbody>
                            ...
                            <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200">
                                ...
                                <td class="pr-9 py-4 text-right">
                                    <form action="{{ route('admin.user.verification', $u->id) }}" method="GET">
                                        @csrf
                                        <button type="submit" class="font-medium text-green-600 hover:text-green-400">
